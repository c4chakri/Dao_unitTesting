...
describe("DaoFactory", function () {
    ...
    async function deployDaoFactoryFixture() {
        ...
        daoManagementContract = daoManagement;
        return { daoFactory };
    }
    async function deployDao(daoSettings,
        govTokenAddress,
        govParams,
        govSettings,
        daoMembers,
        ...
        const dao = await daoFactoryContract.createDAO(
            daoSettings,
            govTokenAddress,
            govParams,
            govSettings,
        ...
        const daoManagementAddress = await daoFactoryContract.daoManagement();
        ...
        return { daoCont, daoManagement, daoAddress, dSettins, dProposal, dgovernanceSettings, governanceTokenContract };
    }
    ...
    describe("Deployment of DAO 1", function () {
        ...
        let DAO_MANAGEMENT;
        let DAO_ADDRESS;
        it("Should deploy new Dao", async function () {
            ...
            const { daoCont, daoManagement, daoAddress, dSettins, dProposal, dgovernanceSettings, governanceTokenContract } = await deployDao(daoSettings,
                govTokenAddress,
                govParams,
                govSettings,
                daoMembers,
            ...
            DAO = daoCont;
            DAO_MANAGEMENT = daoManagement;
            DAO_ADDRESS = daoAddress;
        });

        it("Should create a new proposal to change dao name", async function () {
            ...
            const _actions = await createDaoSettingsAction(DAO_ADDRESS.toString(), daoName, daoData);




            const proposal1 = await DAO_MANAGEMENT.createProposal(DAO_ADDRESS, _title, _description, 2, _startTime, _duration, actionId, _actions);
